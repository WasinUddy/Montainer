...
services:
  montainer:
    ...
    ports:
      ...
      - 8000:8000
    volumes:
      - ./allowlist.json:/minecraft/minecraft-server/allowlist.json
      - ./server.properties:/minecraft/minecraft-server/server.properties
      - ./level:/minecraft/minecraft-server/worlds/Bedrock level
```
